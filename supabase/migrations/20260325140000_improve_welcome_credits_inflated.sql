-- Update the grant_welcome_credits function to use the new inflated amount (250000.0)
...
DECLARE
  ...
  welcome_amount NUMERIC := 250000.0; -- Massive 250k initial credits to match the new multiplier
BEGIN
  ...
  IF NOT FOUND THEN
    ...
    INSERT INTO credit_transactions (
      ...
      welcome_amount, 
      'welcome_bonus', 
      'Welcome bonus - Enjoy 250,000 free credits on us!'
    );
    RETURN TRUE;
  END IF;
